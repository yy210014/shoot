                ...
                if heros[i].Combs[j]:Conditions() then
                    if (heros[i].Combs[j].Enable == false) then
                        ...
                        if (heros[i].tianfu ~= nil) then
                            if (heros[i].CombEnableCount >= 2 and heros[i].tianfu:GetSkill(Misc.GetId("AX06")) ~= nil) then
                                heros[i].tianfu:RemoveSkill(Misc.GetId("AX06"))
...
function Unit:AddComb(comb)
    if (self.CombId == nil) then
        self.CombId = Misc.GetId("J" .. GetPlayerId(self.Player) .. string.sub(Misc.ID2Str(self.Id), 3, 4))
...
function Unit:AddTianfu()
    ...
    tianfu:LearnedSkill(Misc.GetId("AT01"))
    tianfu:LearnedSkill(Misc.GetId("AT02"))
    tianfu:LearnedSkill(Misc.GetId("AT03"))
    tianfu:LearnedSkill(Misc.GetId("AT07"))
